...
def test_dark_theme_by_time():
    ...
    if time(22) <= current_time <= time(23):
        is_dark_theme = True
    elif time(0) <= current_time <= time(6):
        is_dark_theme = True
    else:
        is_dark_theme = False
...
def test_dark_theme_by_time_and_user_choice(is_dark_theme=None):
    ...
    if dark_theme_enabled_by_user:
        ...
        is_dark_theme = False
    elif dark_theme_enabled_by_user is None and time(22) <= current_time <= time(23):
        is_dark_theme = True
    elif dark_theme_enabled_by_user is None and time(0) <= current_time <= time(6):
        is_dark_theme = True
    else:
        is_dark_theme = False
    assert is_dark_theme is True
